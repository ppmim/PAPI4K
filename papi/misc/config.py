...
def read_config_file(config_file = default_config_file()):
    ...
    if nonlinearity["apply"]:
        nonlinearity["model_cntsr"] = read_file_parameter(config, "nonlinearity", "model_cntsr", config_file, True)
        nonlinearity["cds_offset_cntsr"] = read_file_parameter(config, "nonlinearity", "cds_offset_cntsr", config_file, True)
        nonlinearity["model_lir"] = read_parameter(config, "nonlinearity", "model_lir", config_file, True)
        nonlinearity["model_rrrmpia"] = read_parameter(config, "nonlinearity", "model_rrrmpia", config_file, True)
    else:
        nonlinearity["model_cntsr"] = read_parameter(config, "nonlinearity", "model_cntsr", str, False, config_file)
        nonlinearity["cds_offset_cntsr"] = read_parameter(config, "nonlinearity", "cds_offset_cntsr", str, False, config_file)
